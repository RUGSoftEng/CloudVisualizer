...
function addCalculationToDiv(string, totalPrice, canvasID){
    ...
    newListItem +=  '<br><p class="glyphicon glyphicon-share-alt" id='+canvasID+' href="#" onclick="resetCanvas(id)" "float:right">'+ '</p>';
    newListItem +=  '<p class="glyphicon glyphicon-trash" href="#" onclick="console.log(id)">'+ '</p></a>';
